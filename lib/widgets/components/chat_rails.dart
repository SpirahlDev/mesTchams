...
class ChatRails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    GlobalStateManager.checkForMessage();
          ...
          Expanded(
              child: ListView.builder(
                  ...
                  itemBuilder: ((context, index) {
                    return ChatRailTile(
                      contact: GlobalStateManager.messages[index],
...
class ChatRailTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double whiteLineWidth =
        (isMobileScreenContext(context)) ? width : railsWidth;
     ...
     */
    if (postion == 0) {
      dynamicRaduis = const BorderRadius.only(
      ...
      dynamicRaduis = const BorderRadius.only(
          bottomLeft: Radius.circular(raduisValue),
          bottomRight: Radius.circular(raduisValue));
    }
      ...
      child: Column(children: [
        Material(
          ...
          child: InkWell(
            ...
            child: ListTile(
              shape: (dynamicRaduis != null)
                  ? RoundedRectangleBorder(borderRadius: dynamicRaduis)
              ...
              subtitle: Text(
                  truncateText(
                      contact.messages[contact.messages.length - 1].messageText,
                      30),
                  style: const TextStyle(
                    color: Colors.white,
